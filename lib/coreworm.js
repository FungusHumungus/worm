...
module.exports = function(query) {
     ...
     *
     **/
    function deleteChildRows(db, schema_name, parent_id_fields, child_id_fields, parent, insert_only, cascade_delete) {
        if (insert_only)
            return q();
    ...
    function saveChildRecords(db, relationship, parent, children) {
        ...
        return deleteChildRows(db, schema_name, parent_id_fields, child_id_fields, parent, insert_only, cascade_delete)
            .then(function() {
