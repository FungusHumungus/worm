 ...
 *
 **/
function limitTable(table, where, orderby, offset, limit) {
...
query.select = function(db, table, fields, where, orderby, params, joins, offset, limit) {
    ...
    if (offset || limit) {
        table = limitTable(table, where, orderby, offset, limit);
    }
...
query.beginTransaction = function(db) {
    return runQuery(db, 'BEGIN');
};

query.commitTransaction = function(db) {
    return runQuery(db, 'COMMIT');
};

query.rollbackTranscation = function(db) {
