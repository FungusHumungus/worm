...
function deleted(obj) {
    return {status: 'deleted', obj: removePrivates(obj)};
}
...
function getDiffs(model, obj1, obj2) {
    ...
    if (!obj2) return deleted(obj1);

    var schema = schemas.getSchemaForModel(model);

    var changes = _.keys(obj2)
            .filter(function(key) {
                return !_.isObject(obj2[key]) && obj1[key] !== obj2[key];
            })
    ...
    for (var idx in schema.relationships) {
        ...
        if (_.isArray(obj1[relationship.field])) {
            ...
            obj2[relationship.field] = getDiffs(relationship.maps_to,
                                                obj1[relationship.field],
                                                obj2[relationship.field]);
        }
    }
